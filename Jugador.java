...
public class Jugador
{
   ...
   {
     if (nombre == null) throw new IllegallArgumentException("nombre no debe ser null");
     if (nombre.size() == 0) throw new IllegalArgumentException("nombre no debe ser vacio"):
